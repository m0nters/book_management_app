...
class DebtReportEdit extends StatefulWidget {
  final VoidCallback backContextSwitcher;
  const DebtReportEdit({
    super.key,
    required this.backContextSwitcher,
  });

  @override
  State<StatefulWidget> createState() => _DebtReportEditState();
}

class _DebtReportEditState extends State<DebtReportEdit> {
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                              child: Container(
                                ...
                                child: Text('KH05238481', overflow: TextOverflow.ellipsis,),
                              )
                          ),
                          Expanded(
                            child: Container(
                              ...
                              padding: EdgeInsets.all(8.0),
                              child: Text('Nguyễn Thiện Nhân', overflow: TextOverflow.ellipsis,),
                            ),
                          )
                        ],
                      ),
                      ...
                      const Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Text('Nợ đầu',textAlign: TextAlign.center,),
                            ),
                            Expanded(
                            ...
                            Expanded(
                              child: Text('Nợ cuối',textAlign: TextAlign.center,),
                            ),
                          ],
                        ),
                      ),
