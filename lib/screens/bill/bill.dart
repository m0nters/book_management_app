              ...
              child: Column(
                ...
                children: [
                    ...
                    child: const Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('Phiếu thu tiền', style: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.w500),),
                        )
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('Lịch sử', style: TextStyle(fontSize: 20)),
                        Spacer(),
                        IconButton(
                          onPressed: () {},
                          icon: SvgPicture.asset(
                            'assets/icons/new_to_old_3.svg',
                            fit: BoxFit.fill,
                            width: 30,
                            height: 30,
                          ),
                        ...
                        IconButton(
                          onPressed: () {},
                          icon: SvgPicture.asset(
                            'assets/icons/old_to_new_3.svg', // Đảm bảo đường dẫn đúng
                            fit: BoxFit.fill,
                            width: 30,
                            height: 30,
                          ),
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage('assets/images/book_entry_form_ticket.png'),
                                    fit: BoxFit.cover,
                                  ),
                                  boxShadow: [
                                    BoxShadow(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            '${DanhSachPhieu[index]['maphieu']}',
                                            style: TextStyle(color: Color(0xFF858585)),
                                          ),
                                        ),
                                        Expanded(
                                          child: Text(
                                            '${DanhSachPhieu[index]['tenkhachhang']}',
                                            textAlign: TextAlign.right,
                                            style: TextStyle(color: Color(0xFF858585)),
                                          ),
                                        ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            '${DanhSachPhieu[index]['sotienthu']} VNĐ',
                                            textAlign: TextAlign.right,
                                            style: TextStyle(color: Color(0xFF858585)),
                                          ),
                                        ),
